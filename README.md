...
| [anchoredMinHeight](https://pub.dev/documentation/dropdown_button2/latest/dropdown_button2/DropdownStyleData/anchoredMinHeight.html) | The minimum height for the dropdown menu to remain anchored to the button    | double             |    No    |
