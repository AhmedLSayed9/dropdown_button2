...
| [altBarrierColor](https://pub.dev/documentation/dropdown_button2/latest/dropdown_button2/DropdownButton2/altBarrierColor.html)         | The color to use for the modal barrier. This barrier doesn't cover the dropdown button like barrier color. | Color                 |    No    |
