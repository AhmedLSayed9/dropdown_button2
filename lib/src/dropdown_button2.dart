  ...
  Widget build(BuildContext context) {
    ...
    if (dropdownMenuItem.enabled) {
      ...
      child = InkWell(
        ...
        overlayColor: menuItemStyle.overlayColors?[widget.itemIndex],
...
class _DropdownRoute<T> extends PopupRoute<_DropdownRouteResult<T>> {
  ...
  _MenuLimits getMenuLimits(Rect buttonRect, double availableHeight, int index) {
    ...
    double menuTop =
        dropdownStyle.isOverButton ? buttonTop - dropdownStyle.offset.dy : buttonBottom - dropdownStyle.offset.dy;
    double preferredMenuHeight = dropdownStyle.padding?.vertical ?? kMaterialListPadding.vertical;
...
class DropdownButton2State<T> extends State<DropdownButton2<T>> with WidgetsBindingObserver {
  ...
  Rect _getRect() {
    ...
    final NavigatorState navigator = Navigator.of(context, rootNavigator: dropdownStyle.isFullScreen);
